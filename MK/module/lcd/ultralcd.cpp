...
char lcd_status_message[3 * LCD_WIDTH + 1] = WELCOME_MSG; // worst case is kana with up to 3*LCD_WIDTH+1
  ...
  #define LCD_Printpos(x, y)  lcd.setCursor(x, y)
   ...
   static void action_laser_test_800_50ms();
   static void action_laser_test_800_100ms();
   static void action_laser_test_1000_50ms();
   static void action_laser_test_1000_100ms();
   static void action_laser_test_1500_50ms();
   static void action_laser_test_1500_100ms();
...
static void lcd_laser_test_fire_menu() {
   START_MENU();
	...
	MENU_ITEM(function, " 800  50ms", action_laser_test_800_50ms);
	MENU_ITEM(function, " 800 100ms", action_laser_test_800_100ms);
	MENU_ITEM(function, "1000  50ms", action_laser_test_1000_50ms);
	MENU_ITEM(function, "1000 100ms", action_laser_test_1000_100ms);
	MENU_ITEM(function, "1500  50ms", action_laser_test_1500_50ms);
	MENU_ITEM(function, "1500 100ms", action_laser_test_1500_100ms);
...
static void action_laser_test_800_50ms() {
	laser_test_fire(800, 50);
}

static void action_laser_test_800_100ms() {
	laser_test_fire(800, 100);
}

static void action_laser_test_1000_50ms() {
	laser_test_fire(1000, 50);
}

static void action_laser_test_1000_100ms() {
	laser_test_fire(1000, 100);
}

static void action_laser_test_1500_50ms() {
	laser_test_fire(1500, 50);
}

static void action_laser_test_1500_100ms() {
	laser_test_fire(1500, 100);
}
